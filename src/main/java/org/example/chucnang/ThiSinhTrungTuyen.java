...
public class ThiSinhTrungTuyen extends javax.swing.JPanel {
    ...
    public void showResult() throws SQLException {
        ...
        try {
            ...
            String sql = "select MaTS, Hoten, TenKhoi, DaTrungTuyen from HOSOTHISINH inner join KHOIXETTUYEN on HOSOTHISINH.MaKhoi = KHOIXETTUYEN.MaKhoi where DaTrungTuyen = ?";
...
//                pst.setString(3, mats);
                ...
                try {
                    if (tenkhoi.equals("A")) {
                        String sql = "update HOSOTHISINH set DaTrungTuyen =?  where  DiemToan+DiemLi+DiemHoa+TongDiemUuTien>? AND MaKhoi=?";
                        pst = cn.prepareStatement(sql);
                        pst.setString(1, "Trung tuyen");
                        pst.setFloat(2, 15);
                        pst.setString (3, "1");
                        ...
                        pst.setInt(2, 15);
                        pst.setString(3, "4");
                    }else if (tenkhoi.equals("A1")) {
                        String sql = "update HOSOTHISINH set DaTrungTuyen =?  where  DiemToan+DiemNgoaiNgu+DiemLi+TongDiemUuTien>? AND MaKhoi=?";
                        pst = cn.prepareStatement(sql);
                        pst.setString(1, "Trung tuyen");
                        pst.setInt(2, 15);
                        pst.setString(3, "2");
                    ...
                    if (pst.executeUpdate() > 0) {
                        System.out.println("Cập nhâp thành công");
