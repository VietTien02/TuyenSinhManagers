...
public class QuanLyHoSoThiSinh extends javax.swing.JPanel {
    ...
    public void showResult() {
        String[] arr = { "Mã thí sinh", "Họ và tên", "Ngày sinh" , "Giới tính", "Số CMND", "Mã ĐTUT", "Mã KVUT", "Dân tộc", "Mã dân tộc"};
        ...
        try {
            ...
            while(rs.next()) {
                ...
                vc.add(rs.getString("Hoten"));
                vc.add(rs.getString("NgaySinh"));
                vc.add(rs.getString("GioiTinh"));
                vc.add(rs.getString("SoCMND"));
                vc.add(rs.getString("MaDoiTuongUuTien"));
                vc.add(rs.getString("MaKhuVucUuTien"));
    ...
    private void initComponents() {
        ...
        tbQuanLyHoSo.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "Mã thí sinh", "Họ và tên", "Ngày sinh", "Giới tính", "Số CMND", "Mã DTUT", "Mã KVUT", "Dân tộc", "Mã dân tộc"
                }
        ));
...
//
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (dao.update(x) == -1) {
            jOptionPane1.showMessageDialog(null, "Sửa tài khoản thất bại!", "Error", JOptionPane.INFORMATION_MESSAGE);
        } else {
            jOptionPane1.showMessageDialog(null, "Sửa tài khoản thành công!", "Success", JOptionPane.INFORMATION_MESSAGE);
        }
